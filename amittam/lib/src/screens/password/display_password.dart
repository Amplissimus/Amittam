...
class _DisplayPasswordPageState extends State<DisplayPasswordPage> {
  ...
  Widget _secondPage = DisplayQrPage('data');
          ...
          child: Scaffold(
            appBar: StandardAppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () =>
                    {widget.onPop(), FocusScope.of(context).unfocus()},
              ),
            ),
            body: InkWell(
                ...
                ? FloatingActionButton.extended(
                    onPressed: () {
                      ...
                      setState(() {
                        ...
                        password.platform = platformTextFieldController.text
                            .trimRight()
                            .trimLeft();
                        password.notes = notesTextFieldController.text
                            .trimRight()
                            .trimLeft();
                        password.username = usernameTextFieldController.text
                            .trimRight()
                            .trimLeft();
                        Values.passwords[Values.passwords
                            .indexOf(widget.password)] = password;
                        Prefs.passwords = Values.passwords;
                        if (widget.onPop != null) widget.onPop();
                        isEditingNotes = false;
                        isEditingPassword = false;
